...
if (
	...
	class Main extends Tribe__Extension
	{
		...
		function tec_kb_filter_map(array $map)
		{
			...
			include_once __DIR__ . '/src/EventType.php';
			include_once __DIR__ . '/src/EventTag.php';
			include_once __DIR__ . '/src/EventFestival.php';
			include_once __DIR__ . '/src/EventYear.php';


			//$map['filterbar_time_of_day_custom'] = 'Time_Of_Day_Custom';
			$map['filterbar_eventtype'] = 'EventType';
			$map['filterbar_eventtag'] = 'EventTag';
			$map['filterbar_eventfestival'] = 'EventFestival';
			$map['filterbar_eventyear'] = 'EventYear';
		...
		function tec_kb_filter_context_locations(array $locations)
		{
			...
			$locations['filterbar_eventtype'] = [
				'read' => [
					\Tribe__Context::QUERY_VAR   => ['tribe_filterbar_eventtype'],
					\Tribe__Context::REQUEST_VAR => ['tribe_filterbar_eventtype']
				],
			];

			$locations['filterbar_eventtag'] = [
				'read' => [
					\Tribe__Context::QUERY_VAR   => ['tribe_filterbar_eventtag'],
					\Tribe__Context::REQUEST_VAR => ['tribe_filterbar_eventtag']
				],
			];

			$locations['filterbar_eventfestival'] = [
				'read' => [
					\Tribe__Context::QUERY_VAR   => ['tribe_filterbar_eventfestival'],
					\Tribe__Context::REQUEST_VAR => ['tribe_filterbar_eventfestival']
				],
			];

			$locations['filterbar_eventyear'] = [
				'read' => [
					\Tribe__Context::QUERY_VAR   => ['tribe_filterbar_eventyear'],
					\Tribe__Context::REQUEST_VAR => ['tribe_filterbar_eventyear']
				],
			];
		...
		function tec_kb_create_filter()
		{
			...
			new \EventType(
				__('Event Type', 'tribe-events-filter-view'),
				'filterbar_eventtype'
			);
			...
			new \EventFestival(
				__('Event Festival', 'tribe-events-filter-view'),
				'filterbar_eventfestival'
			);

			new \EventFestival(
				__('Event Year', 'tribe-events-filter-view'),
				'filterbar_eventyear'
			);
		}
	} // end class
